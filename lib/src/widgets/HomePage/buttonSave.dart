...
creacionCategoria(nombreCategoria,descripcionCategoria,vacas,toros,becerros,context) async {
  ...
  var categoria = await addCategoria('http://192.168.100.11:3006/categoria/createCategoria',body);
  ...
  if (becerros.length > 0){
    ...
    await createAnimalCategory("http://192.168.100.11:3006/categoria/createCategoryBecerro", BecerrosAgregar.toString());
  }
  if (toros.length > 0){
    ...
    await createAnimalCategory("http://192.168.100.11:3006/categoria/createCategoryToro", TorosAgregar.toString());
  }
  if (vacas.length > 0){
    ...
    await createAnimalCategory("http://192.168.100.11:3006/categoria/createCategoryVaca", VacasAgregar.toString());
  }
