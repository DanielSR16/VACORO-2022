...
class MedicationHitoryCalf extends StatefulWidget {
  ...
  @override
  State<MedicationHitoryCalf> createState() => _MedicationHitoryCalfState();
}

class _MedicationHitoryCalfState extends State<MedicationHitoryCalf> {
  @override
  ...
  FutureBuilder<dynamic> _futureBuilderCalf(Size size) {
    return FutureBuilder(
      future: getMedicationHistoryByCalf(widget.idAnimal),
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (snapshot.data.length > 0) {
            ...
            return Center(
              child: _alertDialogCalf(context),
            );
          }
        }
      },
  ...
  AlertDialog _alertDialogCalf(BuildContext context) {
    return AlertDialog(
      elevation: 20,
      title: Chip(
      ...
      content: RichText(
        ...
        text: TextSpan(
          ...
          children: <TextSpan>[
            const TextSpan(
              text: 'No hay historial medico del becerro ',
              style: TextStyle(
                fontSize: 20,
              ),
            ),
            ...
            const TextSpan(
              text: 'debe registrar medicamentos a este becerro.',
