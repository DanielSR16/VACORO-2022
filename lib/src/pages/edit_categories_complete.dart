...
class _editCategoriesComplete extends State<editCategoriesComplete> {
  ...
  @override
  void initState() {
    Cat = listaCategorias("http://192.168.100.11:3006/categoria/allCategorias");
  ...
  Container botones(context, imagen, texto, tipo) {
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        onPressed: () async => {
          if (tipo == "becerro"){
            idCategoriaB = jsonEncode({"id_categoria":widget.categoriaSeleccionada.idCategoria}),
            listaBecerrosPorCategoria = await listBecerrosByIdCategoria("http://192.168.100.11:3006/categoria/findListBecerrosByIdCategory", idCategoriaB),
          ...
          if (tipo == "vaca"){
            idCategoriaV = jsonEncode({"id_categoria":widget.categoriaSeleccionada.idCategoria}),
            listaVacasPorCategoria = await listVacasByIdCategoria("http://192.168.100.11:3006/categoria/findListVacasByIdCategory", idCategoriaV),
          ...
          if (tipo == "toro"){
            idCategoriaT = jsonEncode({"id_categoria":widget.categoriaSeleccionada.idCategoria}),
            listaTorosPorCategoria = await listTorosByIdCategoria("http://192.168.100.11:3006/categoria/findListTorosByIdCategory", idCategoriaT),
        ...
        onPressed: (){
          ...
          Widget cancelButton = ElevatedButton(
            ...
            Widget continueButton = ElevatedButton(
              ...
              onPressed:  () async {
                var actualizoCategoria = jsonEncode({"id": id,"nombre": nombre,"descripcion": descripcion});
                await AccionarCategoria_edito_elimino('http://192.168.100.11:3006/categoria/updatecategoria',actualizoCategoria);
            ...
            onPressed: () async {
              ...
              Widget continueButton = ElevatedButton(
                ...
                onPressed:  () async {
                  ...
                  await AccionarCategoria_edito_elimino('http://192.168.100.11:3006/categoria/deleteCategoria',idBorrar);
                  Navigator.pop(context);
                  setState(() {
                    Navigator.pushReplacement(context,MaterialPageRoute(builder: (BuildContext context) => editCategories()));
                  });
